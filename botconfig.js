module.exports = {
  Admins: ["469159066128613398", "728931818182541392"], // Admins of the bot, I don't know what this do. -Darren.
  ExpressServer: true, // If you wanted to make the website run or not
  DefaultPrefix: process.env.Prefix || ">", // Default prefix, Server Admins can change the prefix
  Port: 3000, //Which port website gonna be hosted
  SupportServer: "", // Support Server Link
  Token: process.env.Token || "MTA1OTg5NjA1OTk3MjgyOTI4NA.GvDuMG.Gvpp_58pK_QH1CPHnEz5EOsxld1HYl1wO2fr54", // Discord Bot Token
  ClientID: process.env.Discord_ClientID || "1059896059972829284", // Discord Client ID
  ClientSecret: process.env.Discord_ClientSecret || "yi2zdcFzrd1B1-t6z4U6dJcn1PAUG0k1", // Discord Client Secret
  ...
  Spotify: {
    ClientID: process.env.Spotify_ClientID || "b131de607edb4f859304d63eed67faa2", // Spotify Client ID
    ClientSecret: process.env.Spotify_ClientSecret || "a7b330b71ede4d8d9b05c75caeb87902", // Spotify Client Secret
  },
};
